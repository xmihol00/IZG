...
#all necessary matrix or vector operations can be found at https://docs.blender.org/api/current/mathutils.html
    ...
    def createView():
        ...
        Z = mathutils.Matrix.Rotation(radians(13), 4, 'Z') @ (eyePosition - centerPosition)
        Z.normalize()
    ...
    def createTransformation(object, view):
        ...
        #######################
        if objectNumber < 4:
            translation = mathutils.Matrix.Translation((objectNumber - 3, 0.0, 0.0))
        else:
            translation = mathutils.Matrix.Translation((objectNumber - 3, 0.0, 1.0))
